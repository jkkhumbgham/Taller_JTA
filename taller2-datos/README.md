...
Once the runtime starts, you can access the REST end-point at [http://localhost:8080/taller2/rest/hello](http://localhost:8080/taller2/rest/hello).
...
```
./mvnw clean package
docker build -t taller2:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 8080:8080 taller2:v1
```
